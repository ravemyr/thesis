% Spectral Ewald 1P Laplace, basic accuracy/convergence computation
...
t = tic();
ref = SE1P_Laplace_direct_fd_mex(1:Neval, x, f, Dopt);
ref0 = SE1P_Laplace_direct_k0_mex(1:Neval, x, f, Dopt);
ref = ref+ref0;
tDirFour = toc(t);
