...
#ifdef EWALD_REAL
#ifdef ONE_PERIODIC
#define EWALD_KERNEL SE1P_Stokes_direct_real(u, idx, num_eval, x, f, N, opt)
...
#ifdef EWALD_RSRC
#ifdef ONE_PERIODIC
#define EWALD_KERNEL SE1P_Stokes_direct_real_rc(u, idx, num_eval, x, f, N, opt)
...
#ifdef EWALD_DIRECT
#ifdef ONE_PERIODIC
#define EWALD_KERNEL SE1P_Stokes_direct(u, idx, num_eval, x, f, N, opt)
#define EWALD_TAG "D1P"
#else
#error "Must give -DONE_PERIODIC to compiler"
#endif
#endif
...
#ifdef EWALD_SELF
#ifdef ONE_PERIODIC
#define EWALD_KERNEL SE1P_Stokes_direct_self(u, idx, num_eval, f, N, opt)
