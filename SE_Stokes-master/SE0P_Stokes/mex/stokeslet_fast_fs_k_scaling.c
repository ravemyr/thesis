...
#if MX_HAS_INTERLEAVED_COMPLEX
    mxComplexDouble* restrict h1 = mxGetComplexDoubles(H1);
    mxComplexDouble* restrict h2 = mxGetComplexDoubles(H2);
    mxComplexDouble* restrict h3 = mxGetComplexDoubles(H3);
#else
