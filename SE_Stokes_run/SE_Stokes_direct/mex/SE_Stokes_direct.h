...
void SE1P_Stokes_direct_real(double*, const int*, int,
			     const double*, const double*, int,
			     const ewald_opts);

void SE1P_Stokes_direct_real_rc(double*, const int*, int,
				const double*, const double*, int,
				const ewald_opts);

void SE1P_Stokes_direct_fd(double*, const int*, int,
			   const double *, const double*, int,
			   const ewald_opts);

void SE1P_Stokes_direct_k0(double*, const int*, int,
			   const double *, const double*, int,
			   const ewald_opts);

void SE1P_Stokes_direct_self(double*, const int*, int,
			     const double*, int, const ewald_opts);

void SE1P_Stokes_direct(double*, const int*, int,
                        const double*, const double*, int,
                        const ewald_opts);
